...
Reads employee details from the employee database CSV file

Reads attendance records from the attendance CSV file

Calculates hours worked for each cutoff period

Computes payroll values including:
...
Displays payroll results from June to December

Option 2 – Display All Employees

The system automatically:

Reads all employees from the employee database

Processes payroll calculations for each employee

Displays payroll computation results for every employee in the system.
...
One member created the GitHub repository (Host)

Other members were added as Collaborators
...
Ensure the CSV files are located in the src directory
